...
active workspace, delivery helpers enforce the outbound attachment boundary, and
the Knot event log records compact audit rows for deterministic boundary
actions. Task records are not generated by default.

## Operations

- Release validation: [`docs/release-gate.md`](docs/release-gate.md)
- Component sync: [`docs/component-sync.md`](docs/component-sync.md)
- Deployment inputs: [`docs/deployment-inputs.md`](docs/deployment-inputs.md)
- IM smoke testing: [`docs/im-smoke-sop.md`](docs/im-smoke-sop.md)
