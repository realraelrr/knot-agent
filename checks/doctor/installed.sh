...
run_skill_link_checks() {
  ...
  check_skill_link "knot-knowledge" "$ROOT/.skills/knot-knowledge"
  check_skill_link "knot-delivery" "$ROOT/.skills/knot-delivery"
  check_skill_link "working-style" "$ROOT/.skills/working-style"
