...
run_contract_checks() {
  ...
  check_file_contains "$ROOT/.skills/knot-workflow/SKILL.md" "knot-memory" "knot-workflow"
  ...
  check_file_contains "$ROOT/.skills/knot-memory/SKILL.md" "## Boundary" "knot-memory"
  check_file_contains "$ROOT/.skills/knot-memory/SKILL.md" "## Current Runtime Contract" "knot-memory"
