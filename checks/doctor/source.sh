...
run_contract_checks() {
  ...
  check_file_contains "$ROOT/AGENTS.md" "GitHub" "AGENTS.md"
  ...
  check_file_contains "$ROOT/.skills/knot-collaborator-profile/SKILL.md" "bin/knot-collaborator-profile-lint.sh" "knot-collaborator-profile"
