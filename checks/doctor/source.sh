...
run_source_structure_checks() {
  ...
  check_file_exists "$ROOT/.skills/knot-collaborator-profile/SKILL.md" "knot-collaborator-profile skill"
  check_file_exists "$ROOT/lib/knot/core.sh" "Knot core shell library"
  check_file_exists "$ROOT/lib/knot/collaborator-profile-direct.sh" "collaborator profile boundary library"
  ...
  check_executable "$ROOT/bin/knot-collaborator-profile-pack.sh" "knot-collaborator-profile-pack helper"
  check_executable "$ROOT/bin/knot-collaborator-profile-apply.sh" "knot-collaborator-profile-apply helper"
...
run_contract_checks() {
  ...
  check_file_contains "$ROOT/docs/security/security-model.md" "Codex session history" "security model"
  check_file_contains "$ROOT/docs/security/security-model.md" "boundary event records" "security model"
  ...
  check_file_contains "$ROOT/.skills/knot-workflow/SKILL.md" "knot-collaborator-profile" "knot-workflow"
  ...
  check_file_contains "$ROOT/.skills/knot-collaborator-profile/SKILL.md" "## Boundary" "knot-collaborator-profile"
  check_file_contains "$ROOT/.skills/knot-collaborator-profile/SKILL.md" "## Runtime Contract" "knot-collaborator-profile"
  check_file_contains "$ROOT/.skills/knot-collaborator-profile/SKILL.md" "## Agent Usage" "knot-collaborator-profile"
  check_file_contains "$ROOT/.skills/knot-collaborator-profile/SKILL.md" "## Self-Evolution Updates" "knot-collaborator-profile"
  check_file_contains "$ROOT/.skills/knot-collaborator-profile/SKILL.md" "bin/knot-collaborator-profile-pack.sh" "knot-collaborator-profile"
  check_file_contains "$ROOT/.skills/knot-collaborator-profile/SKILL.md" "bin/knot-collaborator-profile-apply.sh" "knot-collaborator-profile"
  check_file_contains "$ROOT/.skills/knot-collaborator-profile/SKILL.md" "read-only" "knot-collaborator-profile"
