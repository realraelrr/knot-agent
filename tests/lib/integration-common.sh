...
clear_knot_env() {
  unset KNOT_ROOT KNOT_SCOPE KNOT_ACTIVE_WORKSPACE KNOT_SCOPE_WORKSPACE \
    KNOT_ACTOR_WORKSPACE KNOT_USER_WORKSPACE KNOT_GROUP_WORKSPACE \
    KNOT_CONVERSATION_DIR KNOT_ACTOR_USER KNOT_ACTOR_NAME \
    KNOT_SOURCE_GROUP KNOT_SOURCE_GROUP_NAME KNOT_GROUP_SLUG \
    KNOT_PLATFORM KNOT_PLATFORM_USER_ID KNOT_CHAT_ID KNOT_IDENTITY_KEY
}
